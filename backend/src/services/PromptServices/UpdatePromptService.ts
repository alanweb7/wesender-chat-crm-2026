...
const UpdatePromptService = async ({
    ...
    const { name, apiKey, prompt, maxTokens, temperature, promptTokens, completionTokens, totalTokens, queueId, maxMessages, voice, voiceKey, voiceRegion, provider, model, ttsModel, audioPercentage, toolsEnabled, knowledgeBase } = promptData;
    ...
    await promptTable.update({ name, apiKey, prompt, maxTokens, temperature, promptTokens, completionTokens, totalTokens, queueId, maxMessages, voice, voiceKey, voiceRegion, provider, model, ttsModel, audioPercentage, knowledgeBase: knowledgeBase || [] });

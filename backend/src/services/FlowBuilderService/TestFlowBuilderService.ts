      ...
      switch (currentNode.type) {
        ...
        case "keywordCondition":
          ...
          for (let i = 0; i < keywords.length; i++) {
            ...
            let searchKeyword = keyword.text.toLowerCase().trim();

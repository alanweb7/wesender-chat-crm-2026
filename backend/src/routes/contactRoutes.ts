...
import * as GoogleMapsScrapeController from "../controllers/GoogleMapsScrapeController";
...
contactRoutes.post("/contacts/google-maps-scrape", isAuth, GoogleMapsScrapeController.startScrape);
contactRoutes.get("/contacts/google-maps-scrape/:jobId", isAuth, GoogleMapsScrapeController.getScrapeStatus);
contactRoutes.get("/contacts/google-maps-scrape/:jobId/csv", isAuth, GoogleMapsScrapeController.downloadScrapeCsv);
contactRoutes.post("/contacts/google-maps-scrape/:jobId/create-list", isAuth, GoogleMapsScrapeController.createListFromScrape);

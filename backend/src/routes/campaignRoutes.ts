...
routes.post("/campaigns/:id/template-media", isAuth, upload.array("file"), CampaignController.templateMediaUpload);
routes.delete("/campaigns/:id/template-media", isAuth, CampaignController.deleteTemplateMedia);

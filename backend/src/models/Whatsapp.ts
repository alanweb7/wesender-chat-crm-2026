...
class Whatsapp extends Model<Whatsapp> {
  ...
  @BelongsTo(() => FlowBuilderModel, { foreignKey: "flowIdNotPhrase", as: "flowNotPhrase" })
  flowNotPhrase: FlowBuilderModel;

  @ForeignKey(() => FlowBuilderModel)
  @Column
  flowIdWelcome: number;

  @BelongsTo(() => FlowBuilderModel, { foreignKey: "flowIdWelcome", as: "flowBuilder" })
  flowBuilder: FlowBuilderModel;

  // Ação de fora do horário de trabalho
  @ForeignKey(() => Queue)
  @AllowNull(true)
  @Column
  outOfHoursQueueId: number;

  @BelongsTo(() => Queue, { foreignKey: "outOfHoursQueueId", as: "outOfHoursQueue" })
  outOfHoursQueue: Queue;

  @ForeignKey(() => FlowBuilderModel)
  @AllowNull(true)
  @Column
  outOfHoursFlowId: number;

  @BelongsTo(() => FlowBuilderModel, { foreignKey: "outOfHoursFlowId", as: "outOfHoursFlow" })
  outOfHoursFlow: FlowBuilderModel;

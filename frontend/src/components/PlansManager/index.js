...
export function PlanManagerForm(props) {
  ...
  <Box>
    <Field
      ...
      helperText="Quantidade de notas fiscais incluídas no plano"
    />
  </Box>

  {/* Valor por Nota Extra */}
  <Box>
    <Field
      as={TextField}
      label="Valor por Nota Extra"
      name="nfPricePerExtra"
      variant="outlined"
      size="small"
      fullWidth
      InputLabelProps={{ style: { fontWeight: "bold" } }}
      ...
      helperText="Valor cobrado por nota fiscal após atingir o limite (ex: 5.50)"
      inputProps={{
        step: 0.01,
        min: 0,
  ...
  {/* Cobrança de Notas Fiscais Ativada */}
  <Box>
    <FormControl
      variant="outlined"
      size="small"
    ...
    >
      <InputLabel
        htmlFor="nf-billing-enabled"
        style={{ fontWeight: "bold" }}
      >
        Cobrança de Notas Fiscais
      </InputLabel>
      <Field as={Select} id="nf-billing-enabled" name="nfBillingEnabled" margin="dense">

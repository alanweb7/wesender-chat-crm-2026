  ...
  pt: {
    translations: {
      ...
      promptModal: {
        ...
        voiceConfig: {
          title: "Configuração de Resposta por Áudio",
          enableAudio: "Habilitar resposta por áudio",
          infoMessage: "Usa a mesma API Key configurada na aba 'Configuração IA'",
          ttsModel: "Modelo TTS",
          voice: "Voz",
          models: {
            tts1: "Rápido e eficiente",
            tts1hd: "Alta qualidade (mais lento)"
          },
          voices: {
            alloy: "Neutro e equilibrado",
            echo: "Masculino e claro",
            fable: "Britânico e expressivo",
            onyx: "Grave e profundo",
            nova: "Feminino e energético",
            shimmer: "Feminino e suave"
          }
        }
      },
      prompts: {
